...
- **Cierre de Ciclo de Cambio:** Archivados los artefactos de propuesta en `finalized/CU31/` (`spec.md`, `design.md`, `tasks.md`) y limpiado el directorio de cambios temporales `changes/CU31/`.
